...
@include("layout/header")
  ...
  <section class="section">
    ...
    <h4 class="title">About Rev Fr Daniel Evbotokhai</h4>
    Fr. Daniel Evbotokhai is a priest of the Catholic Diocese of Auchi, Edo State, Nigeria.  He was ordained October 20th, 2018. He offers his daily homilies, talks and articles that border on, faith, theology, morals and many other burning issues in religion and politics. Fr. Daniel writes poems, inspirational quotes and clips.
    ...
    <div class="sigma_footer-bottom">
      <div class="container-fluid">
        <div class="sigma_footer-copyright">
          <p> Copyright © Witnessline - 2022 <a href="#" class="text-white">2021</a> </p>
        </div>
        <div class="sigma_footer-logo">
          <img src="/assets/img/logo.png" alt="logo" style="width:120px; height:120px" >
        </div>
