...
<link rel="shortcut icon" href="/assets/img/bbd42cd803876b6836b5c9c3f1048dd3.png" type="image/x-icon">
...
<script>
  ...
  OneSignal.push(function() {
    OneSignal.init({
      appId: "5bb4667f-ee84-43e4-845f-fb7dccec49f9",
    });
  });
</script>
  ...
  <title>Sunday's Homily - Witnessline</title>
    ...
    <div class="container">
      <div class="sigma_subheader-inner">
        <div class="sigma_subheader-text">
          <h1>Sunday's Homily</h1>
          <p class="blockquote light"> Witness Is Our Business </p>
        </div>
          ...
          <div class="sidebar">
            ...
            <div class="sidebar-widget widget-recent-posts">
              ...
              <article class="sigma_recent-post">
                <a href="blog-details.html"><img src="/storage/{{$recent->image}}" alt="post"></a>
         ...
         <div class="col-md-6">
          <article class="sigma_post">
            <div class="sigma_post-thumb">
              <a href="/post/{{$posts->slug}}/{{$posts->id}}">
                <img src="/storage/{{$posts->image}}" alt="post" style="width:370px; height:200px">
              </a>
            </div>
            <div class="sigma_post-body">
              <div class="sigma_post-meta">
                <div class="me-3">
                  ...
                  <a href="blog-details.html" class="sigma_post-category">{{$posts->category->name}}</a>
                </div>
                <a href="blog-details.html" class="sigma_post-date"> <i class="far fa-calendar"></i> {{$posts->created_at}}</a>
              </div>
              <h5> <a href="/post/{{$posts->slug}}/{{$posts->id}}">{{$posts->title}}</a> </h5>
              <div class="sigma_post-single-author">
                <img src="/storage/{{$posts->user->avatar}}" alt="author">
                <div class="sigma_post-single-author-content">
                  By <p>{{$posts->user->name}}</p>
                </div>
              </div>
            </div>
          </article>
